...
Hlavnou motiváciou je vytvorenie autonómneho, stabilného a kompaktného riadiaceho riešenia, ktoré úspešne 
...
transformáciu požiadaviek z kartézskeho priestoru do kĺbových súradníc robota. 
...
Okrem samotného algoritmu pohybu projekt zahŕňa aj integráciu používateľského rozhrania (LCD displej 
a joystick s tlačidlami) na manuálne zadávanie cieľových súradníc a 
pokročilú nadstavbu v podobe 3D mapovania priestoru pomocou laserového senzora vzdialenosti VL53L1X 
...
(tlmiaci parameter $\lambda$). Tento projekt je vysoko relevantný, 
