...
Snímač je fyzicky upevnený priamo na \textbf{koncovom efektore} robotického ramena. Vďaka tomuto umiestneniu na samom konci kinematického reťazca sa zorné pole senzora posúva a natáča spolu s efektorom. To otvára možnosti pre dynamické merania, napríklad 3D mapovanie pracovného priestoru pripojením nameranej vzdialenosti k aktuálnym kĺbovým a polohovým súradniciam ramena.
