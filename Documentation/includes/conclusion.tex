...
STM32. Celé programové vybavenie bolo implementované v jazyku C++ bez 
...
(FreeRTOS). Determinizmus systému sme dosiahli vďaka dôslednému rozdeleniu
 procesov na samostatné paralelné úlohy, ktoré bezpečne a s nízkou 
...
Taktiež sme si vyškúšali namodelovať istú časť manipulátora, ktorú sme aj
spojili na druhom manipulátore.
